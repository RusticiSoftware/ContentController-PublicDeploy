...
## Getting the Latest Playbooks

To switch to the latest version of the playbooks:

1. Run `git pull` to pull down the latest version list.
1. Run `git branch -a` to see a list of available versions.
1. Run `git checkout v2.1.0` replacing the version number with the version from the list that you need.
